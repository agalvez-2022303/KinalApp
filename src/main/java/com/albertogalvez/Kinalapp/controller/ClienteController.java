...
import com.albertogalvez.Kinalapp.service.IClienteService;
...
public class ClienteController {
    ...
    public ResponseEntity<List<Cliente>> listarPorEstado(@PathVariable int estado){
        List<Cliente> clientes = clienteService.listarEstado(estado);
        return ResponseEntity.ok(clienteService.listarEstado(estado));
    }
